...
function RedirectToLanding() {
  useEffect(() => {
    ...
    const redirectUrl = `${ENV.CLERK.SIGN_IN_URL}?redirect_url=${encodeURIComponent(ENV.URLS.APP + returnUrl)}`;
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="text-center max-w-md px-4">
        ...
        <a
          href={`${ENV.CLERK.SIGN_IN_URL}?redirect_url=${encodeURIComponent(ENV.URLS.APP + window.location.pathname)}`}
